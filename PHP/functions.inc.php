...
if (strlen($mail)==0) return -1;// если пусто - выход
...
/*function setAutologin($id) 
    { 
        ...
        $res = mysql_query("UPDATE `register`  
                            SET  `hash` = '".$hash."'
                            WHERE `id` = ".$id."'"); 	
    }*/
