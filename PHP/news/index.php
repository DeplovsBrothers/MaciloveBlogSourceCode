...
<!--
		<div id="candy-index-top-apple-300">
		<script type="text/javascript" src="http://aos-creative.prf.hn/creative/camref:11lo4J/creativeref:10l2138/special:rotate"></script>
		</div>
-->
		<?php echo $onAir[3]; ?>
	</div>
