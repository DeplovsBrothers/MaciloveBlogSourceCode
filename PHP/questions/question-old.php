...
<p>'.nl2br(stripslashes($answer_arr['answer'])).'</p>
<div class="answer-comment-toolbar" style="display:none;" name="answer-toolbar-'.$answer_arr['user_id'].'">
	'.$edit_answer.'
</div>
</div>';
...
<meta charset="UTF-8" />
<title><?php echo $title; ?> — Сообщество фанатов Apple</title>
...
<div class="answers-index-box">
	<div class="asnwers-index-category">
		...
		<div class="<?php echo $img_class; ?>"></div>
		<h2><?php echo $type; ?></h2>
		Все вопросы <?php echo $type_num; ?></a>
	</div>
	<div class="answers-index-list answers-index-question">
		...
		<?php echo $name; ?>	
		</span><span id="q-toolbar-<?php echo $question['user_id']; ?>">
		...
		<div class="rate-question" style="display:none;">
			<span>Оцените вопрос</span> ·  ·  ·  ·  ·
		</div>
	</div>
</div>

<div class="answers-best-box" <?php echo $hide_best; ?>>
<div class="asnwers-index-category asnwers-index-best">
	<h3>Лучшие</h3>
</div>
...
<div id="answers_box_id" class="answers-box" <?php echo $hide_answer; ?>>
<div class="asnwers-index-category asnwers-index-best">
	<h3>Все ответы</h3>
</div>

<div class="answer-comment-box" id="parrent_comment_box">
...
<div class="add-answer">
	...
	<span id="name-p"><?php echo $user['name']; ?><span class="sep">|</span> <a href="javascript:log_out()">Выход</a></span>
	<a href="javascript:switch_the_trigger();" class="switcher" id="comments-subscribe-0">Уведомлять об ответах</a>
	<input name="comment_update" type="hidden" id="comments-hidden" value="0">
	<span><a href="javascript:switch_the_trigger();" id="comments_image_trigger" class="switcher-icon-right"></a></span>
	</div>
