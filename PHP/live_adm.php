...
$query = mysql_query("SELECT `id`, `type`,`content`, UNIX_TIMESTAMP(`time`) FROM `live` WHERE `presentation`=".$presentation_number." ORDER BY `id` DESC LIMIT ".$limit.",10");
...
$published = $hour.':'.$minute.'<span style="color:#BFBFBF; font-weight: normal;">:'.$second.'</span>';
...
$all_content .='<div class="live-news">
			<a href="http://macilove.com/live_edit.php?id='.$cont[$n]['id'].'" target="_blank">edit</a><br />
...
var stop_autoposting = <?php echo $stop_autoposting; ?>
