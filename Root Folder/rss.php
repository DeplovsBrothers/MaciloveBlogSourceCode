...
$query_new = mysqli_query($link_new, "SELECT `title`, UNIX_TIMESTAMP(`pub_date`), `url`, `description` FROM `articles` WHERE `draft`=1 ORDER BY `id` DESC LIMIT 0,50");
...
$cut = htmlspecialchars('<a href="http://macilove.com/news/'.$url.'/"><img src="http://macilove.com/img/thumbnails/'.$url.'-l.jpg"></a><br />'.$description);
...
$cut = htmlspecialchars('<a href="http://macilove.com/news/'.$url.'/"><img src="http://macilove.com/images/'.$url.'-l.jpg"></a><br />'.$cut);
